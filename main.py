...
BULLET_HIT_SOUND = pygame.mixer.Sound("./Assets/gunHit.ogg")
BULLET_FIRE_SOUND = pygame.mixer.Sound("./Assets/gunFire.ogg")
...
def yellow_handle_movement(key_pressed, yellow):
    if key_pressed[pygame.K_a] and yellow.x - VEL > 0 :  # Left
        yellow.x -= VEL
    if key_pressed[pygame.K_d] and yellow.x + VEL + yellow.width < BORDER.x +15:  # right
        yellow.x += VEL
